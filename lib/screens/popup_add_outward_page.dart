...
class PopUpAddOutward extends StatefulWidget {
  //final String? flag;
  final Function() changeStateCallback;
  const PopUpAddOutward({
    Key? key,
    //required this.flag,
  ...
  @override
  State<PopUpAddOutward> createState() => _PopUpAddOutward();
}

class _PopUpAddOutward extends State<PopUpAddOutward> {
  ...
  String customerName = "";
  String? _dropdownProductTypesValue = "FRZ";
  String? _dropdownOutwardTypesValue = "DISPATCH";
  //String flag = "";
  ...
  void initState() {
    ...
    getUsername();
    etdController.text = DateTime.now().toString();
    //personOrderedController.text = "";
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Add outward details in the form below.',
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return "Please enter Pallet Customer";
                    }
                    return null;
                  },
                ),
                ...
                DropdownButtonFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return "Please select Outward Type";
                    }
                    return null;
                  },
                ),
  ...
  void getUsername() async {
    ...
    setState(() {
      personOrderedController.text = prefs.getString('username').toString();
      personBookedController.text = prefs.getString('username').toString();
    });
  }
  ...
  Future<void> addData() async {
    ...
    final body = {
      ...
      "person_booked": null,
      "person_dispatched": null,
      "memo": memo,
    };
    // Submit data to the server
    final isSuccess = await OutwardService.addOutward(body);
    if (isSuccess) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Outward details added'),
      ));
